...
This project is a home lab created to practice system administration and IT support skills.

The goal was to simulate a small business environment using Windows Server and client machines.
...
- Practiced DHCP scope configuration
- Tested client network communication

### Group Policy
- Created and tested Group Policies
- Managed user and computer settings
...
![image alt](https://github.com/romannnoori09/Windows-Server-Active-Directory-Lab/blob/main/AD-Users-Groups.png%202.PNG)
![image alt](https://github.com/romannnoori09/Windows-Server-Active-Directory-Lab/blob/main/AD-Users-Groups.png%203.PNG)
![image alt](https://github.com/romannnoori09/Windows-Server-Active-Directory-Lab/blob/main/AD-Users-Groups.png%204.PNG)
